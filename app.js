...
var _elm_community$elm_time$Time_TimeZone$base60String = _Bogdanp$elm_combine$Combine$regex('[0-9a-zA-Z]+');
	...
	var decode = A2(
		...
		A2(
			...
			A2(
				...
				_Bogdanp$elm_combine$Combine_Num$sign),
			A2(_Bogdanp$elm_combine$Combine$optional, '', _elm_community$elm_time$Time_TimeZone$base60String)),
		A2(
			_Bogdanp$elm_combine$Combine$optional,
			'',
			A2(
	...
	var decode = A2(
		...
		A2(
			...
			A2(
				...
				A2(
					_Bogdanp$elm_combine$Combine_ops['<*>'],
					A2(_Bogdanp$elm_combine$Combine_ops['<$>'], _elm_community$elm_time$Time_TimeZone$PackedTimeZone, name),
					abbrevs),
				offsets),
			indices),
		diffs);
...
var _elm_community$elm_time$Time_TimeZone$unpack = function (data) {
	var _p19 = A2(_Bogdanp$elm_combine$Combine$parse, _elm_community$elm_time$Time_TimeZone$packedTimeZone, data);
	if (_p19.ctor === 'Ok') {
...
var _user$project$Main$zfill = function (value) {
	var string = _elm_lang$core$Basics$toString(value);
	return _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$String$length(string),
		1) ? A2(_elm_lang$core$Basics_ops['++'], '0', string) : string;
};
var _user$project$Main$showDate = function (datetime) {
	var minute = _elm_community$elm_time$Time_ZonedDateTime$minute(datetime);
	var hour = _elm_community$elm_time$Time_ZonedDateTime$hour(datetime);
	var year = _elm_community$elm_time$Time_ZonedDateTime$year(datetime);
	var month = _elm_community$elm_time$Time_ZonedDateTime$month(datetime);
	var day = _elm_community$elm_time$Time_ZonedDateTime$day(datetime);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Main$zfill(day),
		A2(
			_elm_lang$core$Basics_ops['++'],
			'/',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Main$zfill(month),
				A2(
					_elm_lang$core$Basics_ops['++'],
					'/',
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$Main$zfill(hour),
								A2(
									_elm_lang$core$Basics_ops['++'],
									':',
									_user$project$Main$zfill(minute)))))))));
};
var _user$project$Main$timeZoneOption = F2(
...
var _user$project$Main$buildTimeZonesOptions = function (selectedTimeZone) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$Main$timeZoneOption(selectedTimeZone),
		_elm_lang$core$Dict$keys(_elm_community$elm_time$Time_TimeZones$all));
};
...
var _user$project$Main$GetTime = {ctor: 'GetTime'};
...
var _user$project$Main$getCurrentTime = A2(_elm_lang$core$Task$perform, _user$project$Main$OnTime, _elm_lang$core$Time$now);
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {
		selectedTimeZones: _elm_lang$core$Set$fromList(
			A2(
				_elm_lang$core$List$map,
				_elm_community$elm_time$Time_TimeZone$name,
				{
					ctor: '::',
					_0: _elm_community$elm_time$Time_TimeZones$europe_paris(
						{ctor: '_Tuple0'}),
					_1: {
						ctor: '::',
						_0: _elm_community$elm_time$Time_TimeZones$america_new_york(
							{ctor: '_Tuple0'}),
						_1: {
							ctor: '::',
							_0: _elm_community$elm_time$Time_TimeZones$america_vancouver(
								{ctor: '_Tuple0'}),
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p2.ctor) {
			case 'OnTime':
				var datetime = _elm_community$elm_time$Time_DateTime$fromTimestamp(_p2._0);
				return {
					ctor: '_Tuple2',
			...
			case 'AddTimeZone':
				var _p3 = model.selectedTimeZone;
				if (_p3.ctor === 'Nothing') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								selectedTimeZones: A2(_elm_lang$core$Set$insert, _p3._0, model.selectedTimeZones),
								selectedTimeZone: _elm_lang$core$Maybe$Nothing
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'SelectTimeZone':
				var _p4 = _p2._0;
				return _elm_lang$core$Native_Utils.eq(_p4, _user$project$Main$emptySelectValue) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{selectedTimeZone: _elm_lang$core$Maybe$Nothing}),
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							selectedTimeZone: _elm_lang$core$Maybe$Just(_p4)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RemoveTimeZone':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							selectedTimeZones: A2(_elm_lang$core$Set$remove, _p2._0, model.selectedTimeZones)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ChangeTime':
...
var _user$project$Main$RemoveTimeZone = function (a) {
	return {ctor: 'RemoveTimeZone', _0: a};
};
var _user$project$Main$getTime = F2(
	function (currentTime, timeZone) {
		var timezone = _elm_community$elm_time$Time_TimeZones$fromName(timeZone);
		var iso8601 = function () {
			var _p5 = timezone;
			if (_p5.ctor === 'Nothing') {
				return 'Unknown';
			} else {
				return _elm_community$elm_time$Time_ZonedDateTime$toISO8601(
					A2(_elm_community$elm_time$Time_ZonedDateTime$fromDateTime, _p5._0, currentTime));
			}
		}();
		var time = function () {
			var _p6 = timezone;
			if (_p6.ctor === 'Nothing') {
				...
				return _user$project$Main$showDate(
					A2(_elm_community$elm_time$Time_ZonedDateTime$fromDateTime, _p6._0, currentTime));
			}
		}();
		return A2(
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$title(iso8601),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									...
									_elm_lang$html$Html$a,
									{
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Main$RemoveTimeZone(timeZone)),
											_1: {ctor: '[]'}
										}
									},
									{
...
var _user$project$Main$displayTime = F2(
	function (selectedTimeZones, currentTime) {
		return A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					_user$project$Main$getTime(currentTime),
					_elm_lang$core$Set$toList(selectedTimeZones))));
	});
var _user$project$Main$SelectTimeZone = function (a) {
	return {ctor: 'SelectTimeZone', _0: a};
};
var _user$project$Main$AddTimeZone = {ctor: 'AddTimeZone'};
var _user$project$Main$addTimezoneForm = function (selectedTimeZone) {
	var emptySelected = function () {
		var _p7 = selectedTimeZone;
		if (_p7.ctor === 'Nothing') {
			return true;
		} else {
			return false;
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SelectTimeZone),
					_1: {ctor: '[]'}
				},
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$selected(emptySelected),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(_user$project$Main$emptySelectValue),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
					_user$project$Main$buildTimeZonesOptions(selectedTimeZone))),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$AddTimeZone),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$GetTime),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												...
												_0: _debois$elm_mdl$Material_Slider$view(
													{
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _debois$elm_mdl$Material_Slider$min(-1440),
																	_1: {ctor: '[]'}
																}
															}
														}
